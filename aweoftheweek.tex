...
\\[4mm]
You won't need to answer every one of these questions to make agents or begin the game, nor will the answers directly change the rules or playbooks.  This is an aid to help everyone get their heads into the same space; to ensure you're all envisioning a similar experience ahead.  Even with the Keeper guiding the process, asking and answering these questions before and throughout agent creation is a job for everyone at the table.  Likewise, since everyone shows up to the table with a different expectation about the game's tone and character, this is a great time to identify and settle out those differences. 
%
