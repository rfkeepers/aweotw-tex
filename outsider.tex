...
\begin{history}
\begin{itemize}
\item They helped you at a critical point in your quest to find the truth. Tell them what you needed help with.
\item They stood between you and what you needed to find out. Ask them why.
\item They also lost a friend or relative to the paranormal. Ask them who it was.
\item Relations, close or distant. Tell them exactly what.
\item You respect their hard-earned knowledge, and often come to them for advice.
\item They introduced you to the Bureau when you were learning the truth about the paranormal.
\item They saw you absolutely lose it and go unhinged. Tell them what the situation was, and ask them how much collateral damage you caused.
\end{itemize}
\end{history}
%
}{% -- pg.2/2 col.3/3
